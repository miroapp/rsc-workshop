	...
	return (
		<div className="grid wrapper">
			<div className="cs1 ce12">
				<Image src={congratulations} alt="Congratulations" style={{width: '100%', height: 'auto'}} priority/>
			</div>
			<div className="cs1 ce12">
			...
			<div className="cs1 ce12">
				...
				<ul>
					{ !!boards.length && boards?.map(b => <li key={b.id}> {b.name} </li>) }
				</ul>
			</div>
			<div className="cs1 ce12">
				<p>
			...
			<div className="cs1 ce12">
				...
				<ul>
					...
					<li><Link target="_blank" href="https://miroapp.github.io/api-clients/index.html">miro-api client docs</Link></li>
				</ul>
			</div>
		</div>
	)
